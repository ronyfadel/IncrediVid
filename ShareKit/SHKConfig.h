 ...
 */
#define SHKTwitterConsumerKey		@"vKdVpp9GstApoSFZ5vQh5A"
#define SHKTwitterSecret			@"n9CMTjxJBH9Jy2sn3KD8fCbNJAaYZXDiQ7sVppHFi0E"
#define SHKTwitterCallbackUrl		@"http://www.twistadioapp.com/incredivid.php" // You need to set this if using OAuth, see note above (xAuth users can skip it)
